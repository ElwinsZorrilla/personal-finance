...
| m26 | CR-008 | El comercio del retiro en sucursal queda como `BANCO POPULAR OF.CHAR DE`, truncado por el propio banco | La normalización de comercios de la Fase 6 los agrupa igual, y el dato de origen no da para más | Fase 8, si la clasificación necesita distinguir sucursales |
